 ...
 * 大于等于运算符处理器
 */
class GreaterThanEqualHandler implements ITokenHandler
{
    /**
     * 判断是否可以处理
     *
    ...
    {
        return $lexer->getCurrentChar() === TokenType::GT && $lexer->peekChar() === TokenType::ASSIGN;
    }
    ...
    {
        return new Token(TokenType::GTE, $lexer->nextChar() . $lexer->nextChar());
    }
}
