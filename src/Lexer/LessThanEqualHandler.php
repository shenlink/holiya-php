 ...
 * 小于等于运算符处理器
 */
class LessThanEqualHandler implements ITokenHandler
{
    /**
     * 判断是否可以处理
     *
    ...
    {
        return $lexer->getCurrentChar() === TokenType::LT && $lexer->peekChar() === TokenType::ASSIGN;
    }
    ...
    {
        return new Token(TokenType::LTE, $lexer->nextChar() . $lexer->nextChar());
    }
}
