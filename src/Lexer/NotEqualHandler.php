 ...
 * 不等于运算符处理器
 */
class NotEqualHandler implements ITokenHandler
{
    /**
     * 判断是否可以处理
     *
    ...
    {
        return $lexer->getCurrentChar() === TokenType::BAND && $lexer->peekChar() === TokenType::ASSIGN;
    }
    ...
    {
        return new Token(TokenType::NEQ, $lexer->nextChar() . $lexer->nextChar());
    }
}
